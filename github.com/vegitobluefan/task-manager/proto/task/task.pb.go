...
const file_proto_task_proto_rawDesc = "" +
	"\n" +
	"\x10proto/task.proto\x12\x04task\"\x1d\n" +
	...
	"\n" +
	"CreateTask\x12\x17.task.CreateTaskRequest\x1a\x18.task.CreateTaskResponseB2Z0github.com/vegitobluefan/task-manager/proto/taskb\x06proto3"
